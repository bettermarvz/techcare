import { Patient } from "@/features/patients/type";
    ...
    <div className="px-5 py-8 bg-white flex flex-col items-center rounded-2xl">
      ...
      <div className="flex flex-col gap-6 mt-8 w-full justify-start">
        <Item
          ...
          url="/icon/BirthIcon.svg"
          label="Date Of Birth"
          value={dayjs(date_of_birth).format("MMMM D, YYYY")}
        />
        <Item
          alt="Gender Icon"
          url="/icon/FemaleIcon.svg"
          label="Gender"
          value={gender}
        />
        <Item
          alt="Contact Info Icon"
          url="/icon/PhoneIcon.svg"
          label="Contact Info."
          value={phone_number}
        />
        <Item
      ...
      <button
        type="button"
        className="flex items-center text-sm font-bold gap-3 py-3 rounded-full hover:bg-[#F6F7F8] bg-[#01F0D0] px-10 mt-[51px]"
      >
